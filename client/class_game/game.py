...
class Game(GameProperty):
    ...
    def draw_player_stats(self):
        ...
        self.wood_img = pg.image.load(os.path.join(images_dir, 'sprites/timber.png')).convert_alpha()
        ...
        self.screen.blit(self.wood, (WIDTH - 40, HEIGHT - 40))
        ...
        self.screen.blit(self.wood_img, (WIDTH - 100, HEIGHT - 50))
